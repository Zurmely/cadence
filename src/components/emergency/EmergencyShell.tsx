  ...
  return (
    <div className="flex flex-col gap-6 text-cadence-text">
      <header className="flex flex-col gap-2">
        <h1 className="text-5xl font-semibold sm:text-6xl">{t(locale, 'emergency.title')}</h1>
        <p className="max-w-3xl text-xl">{t(locale, 'emergency.lead')}</p>
        <div className="flex flex-wrap items-center gap-2 text-lg">
          <span className="rounded-sm border-[1.5px] border-cadence-text px-3 py-1 font-semibold">
